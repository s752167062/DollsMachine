...
import com.base.widget.imageview.CircleImageView;
...
public class GlideDisplay {
    ...
    public static void displayDefaul(ImageView iv, String url) {
    ...
    public static void displayDefaul(ImageView iv, File file) {
        DrawableRequestBuilder<File> builder = Glide.with(iv.getContext()).load(file)
                .placeholder(BG_DEF)
                .error(BG_DEF);
        fitThirdImageView(builder, iv);
    }
